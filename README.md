...
静态托管即可运行（GitHub Pages / Gitee Pages / 腾讯云 COS / 阿里云 OSS 等），详细步骤见 [`部署指南.md`](部署指南.md)。

## 说明

- 成员在自己浏览器中录入/导入的论文仅本人可见；全组共享内容由维护者统一更新
- 设计语言基于 Hallmark（Grid 主题）：瑞士国际主义网格 + 墨色信号，风格与内容同样克制
